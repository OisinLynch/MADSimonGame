...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public boolean addData(String newName) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("player_name", newName);

        db.insert(TABLE_HI_SCORES, null, contentValues);
        return true;
    }
    ...
    void addHiScore(HiScores hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    HiScores getHiScore(int id) {
        ...
        HiScores hiScore = new HiScores(Integer.parseInt(
                cursor.getString(0)),
                cursor.getString(1),
                cursor.getString(2),
                cursor.getInt(3));
    ...
    public List<HiScores> getAllHiScores() {
        List<HiScores> hiScoreList = new ArrayList<HiScores>();
        // Select All Query
    ...
    public int updateHiScore(HiScores hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteHiScore(HiScores hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public List<HiScores> getTopFiveScores() {
        List<HiScores> hiScoreList = new ArrayList<HiScores>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_HI_SCORES +
                " ORDER BY SCORE DESC " +
